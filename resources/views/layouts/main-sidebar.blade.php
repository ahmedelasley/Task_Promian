...
<aside class="app-sidebar sidebar-scroll">
	...
	<div class="main-sidemenu">
			...
			<div class="dropdown user-pro-body">
				<a href="#">
					<div class="">
						...
						<img src="{{ URL::asset('images/user.png') }}" class="avatar avatar-xl brround"><span class="avatar-status profile-status bg-green"></span>
		...
		<ul class="side-menu ">
			<li class="side-item side-item-category">ProMina</li>
			<li class="slide">
				<a class="side-menu__item" href="{{ route('home') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label tx-16">Dashbord</span></a>
			</li>
			<li class="slide my-2">
				<a class="side-menu__item" href="{{ route('albums') }}"><span class="side-menu__icon"><i class="fe fe-layers"></i></span><span class="side-menu__label pd-t-8 tx-16 tx-facebook">Albums</span></a>
			</li>
